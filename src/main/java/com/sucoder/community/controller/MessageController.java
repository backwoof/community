...
public class MessageController implements CommunityConstant {
    ...
    private User getLetterTarget(String conversationId){
        ...
        return hostHolder.getUser().getId() == id0?userService.findUserById(id1):userService.findUserById(id1);
    }
    ...
    public String sendLetter(String toName,String content){
        ...
        message.setConversationId(message.getToId()<message.getFromId()?message.getToId()+"_"+message.getFromId():message.getFromId()+"_"+message.getToId());
...
//            messageVO.put("postId",data.get("postId"));
    ...
    public String getNoticeDetail(@PathVariable("topic") String topic,Page page,Model model){
        ...
        if (notices!=null){
            ...
            model.addAttribute("noticeVOList",noticeVo);
            //设置已读
            List<Integer> noticeIds = getLetterIds(notices);
            if (!noticeIds.isEmpty()){
                messageService.readMessage(noticeIds);
            }
        }
